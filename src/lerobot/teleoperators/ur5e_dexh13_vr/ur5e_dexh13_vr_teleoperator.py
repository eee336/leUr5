    ...
    def __init__(self, config: UR5eDexH13VRTeleoperatorConfig):
        ...
        self.hand_teleop = DexH13VRTeleoperator(
            DexH13VRTeleoperatorConfig(
                ...
                hand_mapping_backend=config.hand_mapping_backend,
                retargeting_config_path=config.hand_retargeting_config_path,
                retargeting_urdf_dir=config.hand_retargeting_urdf_dir,
                fallback_to_geometry=config.hand_fallback_to_geometry,
